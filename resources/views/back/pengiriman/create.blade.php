...
@section('title','CREATE Daftar Pengiriman ')
			...
			<div class="card full-height">
				<div class="card-header">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{route('pengirim.index')}}"class="btn btn-primary btn-sm ml-auto"> KEMBALI</a>
					</div>
				</div>
				<div class="card-body">
                        <div class="table-responsive">
                                ...
                                <div class="form-group">
                                     <label for="barang">Barang</label>
                                        ...
                                        <input type="text" class="form-control" id="number"name="jumlah_barang" placeholder="masukan jumlah barang" required>
                                      </div>
