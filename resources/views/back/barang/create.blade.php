			...
			<div class="card full-height">
				<div class="card-header">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{route('barang.index')}}"class="btn btn-primary btn-sm ml-auto"> KEMBALI</a>
					</div>
				</div>
				<div class="card-body">
                        <div class="table-responsive">
                                <form action="{{route('barang.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <textarea class="form-control" id="editor1" name="description" required></textarea>
                                        ...
                                        <input type="text" class="form-control" id="number"name="stok_barang" placeholder="masukan jumlah stok" required>
                                      </div>
